  ...
  char_T *identifier, emxArray_real_T *y)
{
  ...
  b_emlrt_marshallIn(sp, emlrtAlias(pr), &thisId, y);
                    ...
                    *plhs[2])
{
  ...
  emxInit_real_T(&st, &pr, 2, true);
  emxInit_real_T(&st, &pw, 2, true);

  /* Marshall function inputs */
  pr->canFreeData = false;
  emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "pr", pr);
  pw->canFreeData = false;
  emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "pw", pw);

  /* Invoke the target function */
  calibrate2(pr, pw, *rHat, *tHat);
